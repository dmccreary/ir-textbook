...
| Feature | Status | Effort | Notes |
|---------|--------|--------|-------|
| Glossary | :white_check_mark: | Medium | 293 terms with ISO 11179 compliant definitions |
| FAQ page | :white_check_mark: | Medium | 87 answers to common student questions |
...
| Feature | Status | Effort | Notes |
|---------|--------|--------|-------|
| MicroSims (interactive simulations) | :white_check_mark: | High | 5 browser-based apps for hands-on learning |
| MicroSim index catalog | :x: | Medium | Visual gallery with cards showing all available simulations |
| Per-chapter quizzes | :white_check_mark: | High | 15 quiz files with questions aligned to learning objectives |
