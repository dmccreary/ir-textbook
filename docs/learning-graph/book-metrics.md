...
|---|---------|-------|--------|-------|
| 1 | Concepts | 298 | Required | Concepts from learning graph |
...
| 5 | Chapter Quizzes | 15 / 15 | Recommended | Chapters with a quiz.md (203 questions total) |
...
| 9 | Words | 140,979 | Required | Words across student-facing markdown |
...
| Equations | 17 | 16 | LaTeX expressions (inline and display) |
| Total Words | 140,979 | 106,703 | Words in markdown files |
| Links | 481 | 340 | Hyperlinks in markdown format |
| Equivalent Pages | 566 | 429 | Estimated pages (250 words/page + visuals) |
